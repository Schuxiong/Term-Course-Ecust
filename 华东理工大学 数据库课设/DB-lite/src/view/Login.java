...
public class Login extends JFrame {
	...
	public void init() {
		...
		this.addPart();
		this.addLis();
		this.setTitle("Welcome to DBMS-lite, please log in first");
	...
	public void addLis() {
		...
		enter.addActionListener(e -> {
			...
			try {
				...
				while ((thisLine = br.readLine()) != null) {
					...
					if (oneUser[0].equals(user) && oneUser[1].equals(psw)) {
						...
						if ("1".equals(oneUser[2])) {
							JOptionPane.showMessageDialog(pan, "Admin: " + user + " 登录成功\n即将跳转...");
						} else {
							JOptionPane.showMessageDialog(pan, "User: " + user + " 登录成功\n即将跳转...");
						}
				...
				if (!flag) {
					JOptionPane.showMessageDialog(pan, "The user name or password is incorrect");
