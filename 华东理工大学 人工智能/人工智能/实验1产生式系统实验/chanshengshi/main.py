...
class GUI():
    ...
    def display_rules(self):
        Rules = []
        with open("D:/桌面/大三上/人工智能/实验1产生式系统实验/chanshengshi/Rule.txt", 'r', encoding='gb18030') as f3:
            for line in f3:
                line = line.split()
                Rules.append(line)
            f3.close()
    ...
    def add_rules(self):
        ...
        file = open('D:/桌面/大三上/人工智能/实验1产生式系统实验/chanshengshi/Rule.txt', 'a')
        file.write('\n' + info)
        file.close()
...
def Database(file1, file2, file3):
    ...
    with open(file2, 'r', encoding='utf8') as f2:
        for line in f2.readlines():
            ...
            Feature.extend(line)
        f2.close()
    with open(file3, 'r', encoding='gb18030') as f3:
        for line in f3:
            line = line.split()
            Rules.append(line)
        f3.close()
...
file1_path = "D:/桌面/大三上/人工智能/实验1产生式系统实验/chanshengshi/Plants.txt"
file2_path = "D:/桌面/大三上/人工智能/实验1产生式系统实验/chanshengshi/Feature.txt"
file3_path = "D:/桌面/大三上/人工智能/实验1产生式系统实验/chanshengshi/Rule.txt"
